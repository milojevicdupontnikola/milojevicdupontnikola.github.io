...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function wo(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Na(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Ro(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Na(),fragmentShader:`
...
`)}function gp(i,t){let e;switch(t){case Pc:e="Linear";break;case Lc:e="Reinhard";break;case Dc:e="Cineon";break;case Uc:e="ACESFilmic";break;case Nc:e="AgX";break;case Fc:e="Neutral";break;case Ic:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const gr=new U;function _p(){Xt.getLuminanceCoefficients(gr);const i=gr.x.toFixed(4),t=gr.y.toFixed(4),e=gr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Mp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function Di(i){return i!==""}function zo(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ho(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Sp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ma(i){return i.replace(Sp,Ep)}const yp=new Map;function Ep(i,t){let e=Ht[t];if(e===void 0){const n=yp.get(t);if(n!==void 0)e=Ht[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Ma(e)}const Tp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Vo(i){return i.replace(Tp,Ap)}function Ap(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Go(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function bp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===pl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===cc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===nn&&(t="SHADOWMAP_TYPE_VSM"),t}function wp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case pi:case mi:t="ENVMAP_TYPE_CUBE";break;case Gr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Rp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case mi:t="ENVMAP_MODE_REFRACTION";break}return t}function Cp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ml:t="ENVMAP_BLENDING_MULTIPLY";break;case Rc:t="ENVMAP_BLENDING_MIX";break;case Cc:t="ENVMAP_BLENDING_ADD";break}return t}function Pp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Lp(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=bp(e),c=wp(e),u=Rp(e),d=Cp(e),f=Pp(e),m=vp(e),g=xp(s),_=r.createProgram();let p,h,A=e.glslVersion?"#version "+e.glslVersion+`
...
}`;class sm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const r=new Me,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new yn({vertexShader:im,fragmentShader:rm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Be(new qr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class am extends Mi{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,f=null,m=null,g=null;const _=new sm,p=e.getContextAttributes();let h=null,A=null;const E=[],S=[],O=new ut;let C=null;const R=new Re;R.viewport=new se;const I=new Re;I.viewport=new se;const T=[R,I],M=new em;let w=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let nt=E[Y];return nt===void 0&&(nt=new As,E[Y]=nt),nt.getTargetRaySpace()},this.getControllerGrip=function(Y){let nt=E[Y];return nt===void 0&&(nt=new As,E[Y]=nt),nt.getGripSpace()},this.getHand=function(Y){let nt=E[Y];return nt===void 0&&(nt=new As,E[Y]=nt),nt.getHandSpace()};function z(Y){const nt=S.indexOf(Y.inputSource);if(nt===-1)return;const St=E[nt];St!==void 0&&(St.update(Y.inputSource,Y.frame,c||a),St.dispatchEvent({type:Y.type,data:Y.inputSource}))}function k(){r.removeEventListener("select",z),r.removeEventListener("selectstart",z),r.removeEventListener("selectend",z),r.removeEventListener("squeeze",z),r.removeEventListener("squeezestart",z),r.removeEventListener("squeezeend",z),r.removeEventListener("end",k),r.removeEventListener("inputsourceschange",Z);for(let Y=0;Y<E.length;Y++){const nt=S[Y];nt!==null&&(S[Y]=null,E[Y].disconnect(nt))}w=null,W=null,_.reset(),t.setRenderTarget(h),m=null,f=null,d=null,r=null,A=null,Yt.stop(),n.isPresenting=!1,t.setPixelRatio(C),t.setSize(O.width,O.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(h=t.getRenderTarget(),r.addEventListener("select",z),r.addEventListener("selectstart",z),r.addEventListener("selectend",z),r.addEventListener("squeeze",z),r.addEventListener("squeezestart",z),r.addEventListener("squeezeend",z),r.addEventListener("end",k),r.addEventListener("inputsourceschange",Z),p.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(O),r.renderState.layers===void 0){const nt={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,e,nt),r.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),A=new zn(m.framebufferWidth,m.framebufferHeight,{format:Oe,type:ln,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let nt=null,St=null,rt=null;p.depth&&(rt=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,nt=p.stencil?_i:ci,St=p.stencil?gi:Bn);const Rt={colorFormat:e.RGBA8,depthFormat:rt,scaleFactor:s};d=new XRWebGLBinding(r,e),f=d.createProjectionLayer(Rt),r.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),A=new zn(f.textureWidth,f.textureHeight,{format:Oe,type:ln,depthTexture:new zl(f.textureWidth,f.textureHeight,St,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Yt.setContext(r),Yt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function Z(Y){for(let nt=0;nt<Y.removed.length;nt++){const St=Y.removed[nt],rt=S.indexOf(St);rt>=0&&(S[rt]=null,E[rt].disconnect(St))}for(let nt=0;nt<Y.added.length;nt++){const St=Y.added[nt];let rt=S.indexOf(St);if(rt===-1){for(let Ut=0;Ut<E.length;Ut++)if(Ut>=S.length){S.push(St),rt=Ut;break}else if(S[Ut]===null){S[Ut]=St,rt=Ut;break}if(rt===-1)break}const Rt=E[rt];Rt&&Rt.connect(St)}}const H=new U,j=new U;function V(Y,nt,St){H.setFromMatrixPosition(nt.matrixWorld),j.setFromMatrixPosition(St.matrixWorld);const rt=H.distanceTo(j),Rt=nt.projectionMatrix.elements,Ut=St.projectionMatrix.elements,Lt=Rt[14]/(Rt[10]-1),Wt=Rt[14]/(Rt[10]+1),K=(Rt[9]+1)/Rt[5],et=(Rt[9]-1)/Rt[5],b=(Rt[8]-1)/Rt[0],bt=(Ut[8]+1)/Ut[0],Q=Lt*b,_t=Lt*bt,st=rt/(-b+bt),Ct=st*-b;if(nt.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Ct),Y.translateZ(st),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Rt[10]===-1)Y.projectionMatrix.copy(nt.projectionMatrix),Y.projectionMatrixInverse.copy(nt.projectionMatrixInverse);else{const mt=Lt+st,y=Wt+st,v=Q-Ct,N=_t+(rt-Ct),X=K*Wt/y*mt,J=et*Wt/y*mt;Y.projectionMatrix.makePerspective(v,N,X,J,mt,y),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function at(Y,nt){nt===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(nt.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let nt=Y.near,St=Y.far;_.texture!==null&&(_.depthNear>0&&(nt=_.depthNear),_.depthFar>0&&(St=_.depthFar)),M.near=I.near=R.near=nt,M.far=I.far=R.far=St,(w!==M.near||W!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),w=M.near,W=M.far),R.layers.mask=Y.layers.mask|2,I.layers.mask=Y.layers.mask|4,M.layers.mask=R.layers.mask|I.layers.mask;const rt=Y.parent,Rt=M.cameras;at(M,rt);for(let Ut=0;Ut<Rt.length;Ut++)at(Rt[Ut],rt);Rt.length===2?V(M,R,I):M.projectionMatrix.copy(R.projectionMatrix),pt(Y,M,rt)};function pt(Y,nt,St){St===null?Y.matrix.copy(nt.matrixWorld):(Y.matrix.copy(St.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(nt.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(nt.projectionMatrix),Y.projectionMatrixInverse.copy(nt.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=xa*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(Y){l=Y,f!==null&&(f.fixedFoveation=Y),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Y)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)};let Mt=null;function Nt(Y,nt){if(u=nt.getViewerPose(c||a),g=nt,u!==null){const St=u.views;m!==null&&(t.setRenderTargetFramebuffer(A,m.framebuffer),t.setRenderTarget(A));let rt=!1;St.length!==M.cameras.length&&(M.cameras.length=0,rt=!0);for(let Ut=0;Ut<St.length;Ut++){const Lt=St[Ut];let Wt=null;if(m!==null)Wt=m.getViewport(Lt);else{const et=d.getViewSubImage(f,Lt);Wt=et.viewport,Ut===0&&(t.setRenderTargetTextures(A,et.colorTexture,f.ignoreDepthValues?void 0:et.depthStencilTexture),t.setRenderTarget(A))}let K=T[Ut];K===void 0&&(K=new Re,K.layers.enable(Ut),K.viewport=new se,T[Ut]=K),K.matrix.fromArray(Lt.transform.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale),K.projectionMatrix.fromArray(Lt.projectionMatrix),K.projectionMatrixInverse.copy(K.projectionMatrix).invert(),K.viewport.set(Wt.x,Wt.y,Wt.width,Wt.height),Ut===0&&(M.matrix.copy(K.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),rt===!0&&M.cameras.push(K)}const Rt=r.enabledFeatures;if(Rt&&Rt.includes("depth-sensing")){const Ut=d.getDepthInformation(St[0]);Ut&&Ut.isValid&&Ut.texture&&_.init(t,Ut,r.renderState)}}for(let St=0;St<E.length;St++){const rt=S[St],Rt=E[St];rt!==null&&Rt!==void 0&&Rt.update(rt,nt,c||a)}Mt&&Mt(Y,nt),nt.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:nt}),g=null}const Yt=new Bl;Yt.setAnimationLoop(Nt),this.setAnimationLoop=function(Y){Mt=Y},this.dispose=function(){}}}const Pn=new cn,om=new ne;function lm(i,t){function e(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function n(p,h){h.color.getRGB(p.fogColor.value,Il(i)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,A,E,S){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),d(p,h)):h.isMeshPhongMaterial?(s(p,h),u(p,h)):h.isMeshStandardMaterial?(s(p,h),f(p,h),h.isMeshPhysicalMaterial&&m(p,h,S)):h.isMeshMatcapMaterial?(s(p,h),g(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),_(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,A,E):h.isSpriteMaterial?c(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,e(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===xe&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,e(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===xe&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,e(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,e(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,e(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const A=t.get(h),E=A.envMap,S=A.envMapRotation;E&&(p.envMap.value=E,Pn.copy(S),Pn.x*=-1,Pn.y*=-1,Pn.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(Pn.y*=-1,Pn.z*=-1),p.envMapRotation.value.setFromMatrix4(om.makeRotationFromEuler(Pn)),p.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap&&(p.lightMap.value=h.lightMap,p.lightMapIntensity.value=h.lightMapIntensity,e(h.lightMap,p.lightMapTransform)),h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,e(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,A,E){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*A,p.scale.value=E*.5,h.map&&(p.map.value=h.map,e(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function d(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function f(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,e(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,e(h.roughnessMap,p.roughnessMapTransform)),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,A){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,e(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,e(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,e(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,e(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,e(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===xe&&p.clearcoatNormalScale.value.negate())),h.dispersion>0&&(p.dispersion.value=h.dispersion),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,e(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,e(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=A.texture,p.transmissionSamplerSize.value.set(A.width,A.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,e(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,e(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,e(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,e(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,e(h.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,h){h.matcap&&(p.matcap.value=h.matcap)}function _(p,h){const A=t.get(h).light;p.referencePosition.value.setFromMatrixPosition(A.matrixWorld),p.nearDistance.value=A.shadow.camera.near,p.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function cm(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(A,E){const S=E.program;n.uniformBlockBinding(A,S)}function c(A,E){let S=r[A.id];S===void 0&&(g(A),S=u(A),r[A.id]=S,A.addEventListener("dispose",p));const O=E.program;n.updateUBOMapping(A,O);const C=t.render.frame;s[A.id]!==C&&(f(A),s[A.id]=C)}function u(A){const E=d();A.__bindingPointIndex=E;const S=i.createBuffer(),O=A.__size,C=A.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,O,C),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,S),S}function d(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(A){const E=r[A.id],S=A.uniforms,O=A.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let C=0,R=S.length;C<R;C++){const I=Array.isArray(S[C])?S[C]:[S[C]];for(let T=0,M=I.length;T<M;T++){const w=I[T];if(m(w,C,T,O)===!0){const W=w.__offset,z=Array.isArray(w.value)?w.value:[w.value];let k=0;for(let Z=0;Z<z.length;Z++){const H=z[Z],j=_(H);typeof H=="number"||typeof H=="boolean"?(w.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,W+k,w.__data)):H.isMatrix3?(w.__data[0]=H.elements[0],w.__data[1]=H.elements[1],w.__data[2]=H.elements[2],w.__data[3]=0,w.__data[4]=H.elements[3],w.__data[5]=H.elements[4],w.__data[6]=H.elements[5],w.__data[7]=0,w.__data[8]=H.elements[6],w.__data[9]=H.elements[7],w.__data[10]=H.elements[8],w.__data[11]=0):(H.toArray(w.__data,k),k+=j.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,W,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(A,E,S,O){const C=A.value,R=E+"_"+S;if(O[R]===void 0)return typeof C=="number"||typeof C=="boolean"?O[R]=C:O[R]=C.clone(),!0;{const I=O[R];if(typeof C=="number"||typeof C=="boolean"){if(I!==C)return O[R]=C,!0}else if(I.equals(C)===!1)return I.copy(C),!0}return!1}function g(A){const E=A.uniforms;let S=0;const O=16;for(let R=0,I=E.length;R<I;R++){const T=Array.isArray(E[R])?E[R]:[E[R]];for(let M=0,w=T.length;M<w;M++){const W=T[M],z=Array.isArray(W.value)?W.value:[W.value];for(let k=0,Z=z.length;k<Z;k++){const H=z[k],j=_(H),V=S%O,at=V%j.boundary,pt=V+at;S+=at,pt!==0&&O-pt<j.storage&&(S+=O-pt),W.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=S,S+=j.storage}}}const C=S%O;return C>0&&(S+=O-C),A.__size=S,A.__cache={},this}function _(A){const E={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(E.boundary=4,E.storage=4):A.isVector2?(E.boundary=8,E.storage=8):A.isVector3||A.isColor?(E.boundary=16,E.storage=12):A.isVector4?(E.boundary=16,E.storage=16):A.isMatrix3?(E.boundary=48,E.storage=48):A.isMatrix4?(E.boundary=64,E.storage=64):A.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",A),E}function p(A){const E=A.target;E.removeEventListener("dispose",p);const S=a.indexOf(E.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function h(){for(const A in r)i.deleteBuffer(r[A]);a=[],r={},s={}}return{bind:l,update:c,dispose:h}}class um{constructor(t={}){const{canvas:e=Kc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const g=new Uint32Array(4),_=new Int32Array(4);let p=null,h=null;const A=[],E=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=we,this.toneMapping=Mn,this.toneMappingExposure=1;const S=this;let O=!1,C=0,R=0,I=null,T=-1,M=null;const w=new se,W=new se;let z=null;const k=new Gt(0);let Z=0,H=e.width,j=e.height,V=1,at=null,pt=null;const Mt=new se(0,0,H,j),Nt=new se(0,0,H,j);let Yt=!1;const Y=new Ol;let nt=!1,St=!1;const rt=new ne,Rt=new ne,Ut=new U,Lt=new se,Wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let K=!1;function et(){return I===null?V:1}let b=n;function bt(x,L){return e.getContext(x,L)}try{const x={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ba}`),e.addEventListener("webglcontextlost",$,!1),e.addEventListener("webglcontextrestored",dt,!1),e.addEventListener("webglcontextcreationerror",ht,!1),b===null){const L="webgl2";if(b=bt(L,x),b===null)throw bt(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Q,_t,st,Ct,mt,y,v,N,X,J,q,yt,lt,gt,Vt,tt,vt,Pt,Dt,xt,kt,zt,jt,P;function ct(){Q=new md(b),Q.init(),zt=new tm(b,Q),_t=new ld(b,Q,t,zt),st=new Jp(b,Q),_t.reverseDepthBuffer&&f&&st.buffers.depth.setReversed(!0),Ct=new vd(b),mt=new Fp,y=new Qp(b,Q,st,mt,_t,zt,Ct),v=new ud(S),N=new pd(S),X=new Eu(b),jt=new ad(b,X),J=new gd(b,X,Ct,jt),q=new Md(b,J,X,Ct),Dt=new xd(b,_t,y),tt=new cd(mt),yt=new Np(S,v,N,Q,_t,jt,tt),lt=new lm(S,mt),gt=new Bp,Vt=new Wp(Q),Pt=new sd(S,v,N,st,q,m,l),vt=new $p(S,q,_t),P=new cm(b,Ct,_t,st),xt=new od(b,Q,Ct),kt=new _d(b,Q,Ct),Ct.programs=yt.programs,S.capabilities=_t,S.extensions=Q,S.properties=mt,S.renderLists=gt,S.shadowMap=vt,S.state=st,S.info=Ct}ct();const G=new am(S,b);this.xr=G,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const x=Q.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Q.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(x){x!==void 0&&(V=x,this.setSize(H,j,!1))},this.getSize=function(x){return x.set(H,j)},this.setSize=function(x,L,F=!0){if(G.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=x,j=L,e.width=Math.floor(x*V),e.height=Math.floor(L*V),F===!0&&(e.style.width=x+"px",e.style.height=L+"px"),this.setViewport(0,0,x,L)},this.getDrawingBufferSize=function(x){return x.set(H*V,j*V).floor()},this.setDrawingBufferSize=function(x,L,F){H=x,j=L,V=F,e.width=Math.floor(x*F),e.height=Math.floor(L*F),this.setViewport(0,0,x,L)},this.getCurrentViewport=function(x){return x.copy(w)},this.getViewport=function(x){return x.copy(Mt)},this.setViewport=function(x,L,F,B){x.isVector4?Mt.set(x.x,x.y,x.z,x.w):Mt.set(x,L,F,B),st.viewport(w.copy(Mt).multiplyScalar(V).round())},this.getScissor=function(x){return x.copy(Nt)},this.setScissor=function(x,L,F,B){x.isVector4?Nt.set(x.x,x.y,x.z,x.w):Nt.set(x,L,F,B),st.scissor(W.copy(Nt).multiplyScalar(V).round())},this.getScissorTest=function(){return Yt},this.setScissorTest=function(x){st.setScissorTest(Yt=x)},this.setOpaqueSort=function(x){at=x},this.setTransparentSort=function(x){pt=x},this.getClearColor=function(x){return x.copy(Pt.getClearColor())},this.setClearColor=function(){Pt.setClearColor.apply(Pt,arguments)},this.getClearAlpha=function(){return Pt.getClearAlpha()},this.setClearAlpha=function(){Pt.setClearAlpha.apply(Pt,arguments)},this.clear=function(x=!0,L=!0,F=!0){let B=0;if(x){let D=!1;if(I!==null){const it=I.texture.format;D=it===Da||it===La||it===Pa}if(D){const it=I.texture.type,ft=it===ln||it===Bn||it===Oi||it===gi||it===Ra||it===Ca,Et=Pt.getClearColor(),Tt=Pt.getClearAlpha(),It=Et.r,Ot=Et.g,At=Et.b;ft?(g[0]=It,g[1]=Ot,g[2]=At,g[3]=Tt,b.clearBufferuiv(b.COLOR,0,g)):(_[0]=It,_[1]=Ot,_[2]=At,_[3]=Tt,b.clearBufferiv(b.COLOR,0,_))}else B|=b.COLOR_BUFFER_BIT}L&&(B|=b.DEPTH_BUFFER_BIT),F&&(B|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",$,!1),e.removeEventListener("webglcontextrestored",dt,!1),e.removeEventListener("webglcontextcreationerror",ht,!1),gt.dispose(),Vt.dispose(),mt.dispose(),v.dispose(),N.dispose(),q.dispose(),jt.dispose(),P.dispose(),yt.dispose(),G.dispose(),G.removeEventListener("sessionstart",Va),G.removeEventListener("sessionend",Ga),Tn.stop()};function $(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),O=!0}function dt(){console.log("THREE.WebGLRenderer: Context Restored."),O=!1;const x=Ct.autoReset,L=vt.enabled,F=vt.autoUpdate,B=vt.needsUpdate,D=vt.type;ct(),Ct.autoReset=x,vt.enabled=L,vt.autoUpdate=F,vt.needsUpdate=B,vt.type=D}function ht(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function Ft(x){const L=x.target;L.removeEventListener("dispose",Ft),re(L)}function re(x){ue(x),mt.remove(x)}function ue(x){const L=mt.get(x).programs;L!==void 0&&(L.forEach(function(F){yt.releaseProgram(F)}),x.isShaderMaterial&&yt.releaseShaderCache(x))}this.renderBufferDirect=function(x,L,F,B,D,it){L===null&&(L=Wt);const ft=D.isMesh&&D.matrixWorld.determinant()<0,Et=rc(x,L,F,B,D);st.setMaterial(B,ft);let Tt=F.index,It=1;if(B.wireframe===!0){if(Tt=J.getWireframeAttribute(F),Tt===void 0)return;It=2}const Ot=F.drawRange,At=F.attributes.position;let qt=Ot.start*It,Qt=(Ot.start+Ot.count)*It;it!==null&&(qt=Math.max(qt,it.start*It),Qt=Math.min(Qt,(it.start+it.count)*It)),Tt!==null?(qt=Math.max(qt,0),Qt=Math.min(Qt,Tt.count)):At!=null&&(qt=Math.max(qt,0),Qt=Math.min(Qt,At.count));const te=Qt-qt;if(te<0||te===1/0)return;jt.setup(D,B,Et,F,Tt);let _e,Zt=xt;if(Tt!==null&&(_e=X.get(Tt),Zt=kt,Zt.setIndex(_e)),D.isMesh)B.wireframe===!0?(st.setLineWidth(B.wireframeLinewidth*et()),Zt.setMode(b.LINES)):Zt.setMode(b.TRIANGLES);else if(D.isLine){let wt=B.linewidth;wt===void 0&&(wt=1),st.setLineWidth(wt*et()),D.isLineSegments?Zt.setMode(b.LINES):D.isLineLoop?Zt.setMode(b.LINE_LOOP):Zt.setMode(b.LINE_STRIP)}else D.isPoints?Zt.setMode(b.POINTS):D.isSprite&&Zt.setMode(b.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Zt.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(Q.get("WEBGL_multi_draw"))Zt.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{const wt=D._multiDrawStarts,Ke=D._multiDrawCounts,$t=D._multiDrawCount,De=Tt?X.get(Tt).bytesPerElement:1,Gn=mt.get(B).currentProgram.getUniforms();for(let Se=0;Se<$t;Se++)Gn.setValue(b,"_gl_DrawID",Se),Zt.render(wt[Se]/De,Ke[Se])}else if(D.isInstancedMesh)Zt.renderInstances(qt,te,D.count);else if(F.isInstancedBufferGeometry){const wt=F._maxInstanceCount!==void 0?F._maxInstanceCount:1/0,Ke=Math.min(F.instanceCount,wt);Zt.renderInstances(qt,te,Ke)}else Zt.render(qt,te)};function Kt(x,L,F){x.transparent===!0&&x.side===Fe&&x.forceSinglePass===!1?(x.side=xe,x.needsUpdate=!0,$i(x,L,F),x.side=Sn,x.needsUpdate=!0,$i(x,L,F),x.side=Fe):$i(x,L,F)}this.compile=function(x,L,F=null){F===null&&(F=x),h=Vt.get(F),h.init(L),E.push(h),F.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),x!==F&&x.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),h.setupLights();const B=new Set;return x.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;const it=D.material;if(it)if(Array.isArray(it))for(let ft=0;ft<it.length;ft++){const Et=it[ft];Kt(Et,F,D),B.add(Et)}else Kt(it,F,D),B.add(it)}),E.pop(),h=null,B},this.compileAsync=function(x,L,F=null){const B=this.compile(x,L,F);return new Promise(D=>{function it(){if(B.forEach(function(ft){mt.get(ft).currentProgram.isReady()&&B.delete(ft)}),B.size===0){D(x);return}setTimeout(it,10)}Q.get("KHR_parallel_shader_compile")!==null?it():setTimeout(it,10)})};let Le=null;function $e(x){Le&&Le(x)}function Va(){Tn.stop()}function Ga(){Tn.start()}const Tn=new Bl;Tn.setAnimationLoop($e),typeof self<"u"&&Tn.setContext(self),this.setAnimationLoop=function(x){Le=x,G.setAnimationLoop(x),x===null?Tn.stop():Tn.start()},G.addEventListener("sessionstart",Va),G.addEventListener("sessionend",Ga),this.render=function(x,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(O===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),G.enabled===!0&&G.isPresenting===!0&&(G.cameraAutoUpdate===!0&&G.updateCamera(L),L=G.getCamera()),x.isScene===!0&&x.onBeforeRender(S,x,L,I),h=Vt.get(x,E.length),h.init(L),E.push(h),Rt.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Y.setFromProjectionMatrix(Rt),St=this.localClippingEnabled,nt=tt.init(this.clippingPlanes,St),p=gt.get(x,A.length),p.init(),A.push(p),G.enabled===!0&&G.isPresenting===!0){const it=S.xr.getDepthSensingMesh();it!==null&&Kr(it,L,-1/0,S.sortObjects)}Kr(x,L,0,S.sortObjects),p.finish(),S.sortObjects===!0&&p.sort(at,pt),K=G.enabled===!1||G.isPresenting===!1||G.hasDepthSensing()===!1,K&&Pt.addToRenderList(p,x),this.info.render.frame++,nt===!0&&tt.beginShadows();const F=h.state.shadowsArray;vt.render(F,x,L),nt===!0&&tt.endShadows(),this.info.autoReset===!0&&this.info.reset();const B=p.opaque,D=p.transmissive;if(h.setupLights(),L.isArrayCamera){const it=L.cameras;if(D.length>0)for(let ft=0,Et=it.length;ft<Et;ft++){const Tt=it[ft];Wa(B,D,x,Tt)}K&&Pt.render(x);for(let ft=0,Et=it.length;ft<Et;ft++){const Tt=it[ft];ka(p,x,Tt,Tt.viewport)}}else D.length>0&&Wa(B,D,x,L),K&&Pt.render(x),ka(p,x,L);I!==null&&(y.updateMultisampleRenderTarget(I),y.updateRenderTargetMipmap(I)),x.isScene===!0&&x.onAfterRender(S,x,L),jt.resetDefaultState(),T=-1,M=null,E.pop(),E.length>0?(h=E[E.length-1],nt===!0&&tt.setGlobalState(S.clippingPlanes,h.state.camera)):h=null,A.pop(),A.length>0?p=A[A.length-1]:p=null};function Kr(x,L,F,B){if(x.visible===!1)return;if(x.layers.test(L.layers)){if(x.isGroup)F=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(L);else if(x.isLight)h.pushLight(x),x.castShadow&&h.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||Y.intersectsSprite(x)){B&&Lt.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Rt);const ft=q.update(x),Et=x.material;Et.visible&&p.push(x,ft,Et,F,Lt.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||Y.intersectsObject(x))){const ft=q.update(x),Et=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Lt.copy(x.boundingSphere.center)):(ft.boundingSphere===null&&ft.computeBoundingSphere(),Lt.copy(ft.boundingSphere.center)),Lt.applyMatrix4(x.matrixWorld).applyMatrix4(Rt)),Array.isArray(Et)){const Tt=ft.groups;for(let It=0,Ot=Tt.length;It<Ot;It++){const At=Tt[It],qt=Et[At.materialIndex];qt&&qt.visible&&p.push(x,ft,qt,F,Lt.z,At)}}else Et.visible&&p.push(x,ft,Et,F,Lt.z,null)}}const it=x.children;for(let ft=0,Et=it.length;ft<Et;ft++)Kr(it[ft],L,F,B)}function ka(x,L,F,B){const D=x.opaque,it=x.transmissive,ft=x.transparent;h.setupLightsView(F),nt===!0&&tt.setGlobalState(S.clippingPlanes,F),B&&st.viewport(w.copy(B)),D.length>0&&Zi(D,L,F),it.length>0&&Zi(it,L,F),ft.length>0&&Zi(ft,L,F),st.buffers.depth.setTest(!0),st.buffers.depth.setMask(!0),st.buffers.color.setMask(!0),st.setPolygonOffset(!1)}function Wa(x,L,F,B){if((F.isScene===!0?F.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[B.id]===void 0&&(h.state.transmissionRenderTarget[B.id]=new zn(1,1,{generateMipmaps:!0,type:Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float")?Gi:ln,minFilter:On,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Xt.workingColorSpace}));const it=h.state.transmissionRenderTarget[B.id],ft=B.viewport||w;it.setSize(ft.z,ft.w);const Et=S.getRenderTarget();S.setRenderTarget(it),S.getClearColor(k),Z=S.getClearAlpha(),Z<1&&S.setClearColor(16777215,.5),S.clear(),K&&Pt.render(F);const Tt=S.toneMapping;S.toneMapping=Mn;const It=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),h.setupLightsView(B),nt===!0&&tt.setGlobalState(S.clippingPlanes,B),Zi(x,F,B),y.updateMultisampleRenderTarget(it),y.updateRenderTargetMipmap(it),Q.has("WEBGL_multisampled_render_to_texture")===!1){let Ot=!1;for(let At=0,qt=L.length;At<qt;At++){const Qt=L[At],te=Qt.object,_e=Qt.geometry,Zt=Qt.material,wt=Qt.group;if(Zt.side===Fe&&te.layers.test(B.layers)){const Ke=Zt.side;Zt.side=xe,Zt.needsUpdate=!0,Xa(te,F,B,_e,Zt,wt),Zt.side=Ke,Zt.needsUpdate=!0,Ot=!0}}Ot===!0&&(y.updateMultisampleRenderTarget(it),y.updateRenderTargetMipmap(it))}S.setRenderTarget(Et),S.setClearColor(k,Z),It!==void 0&&(B.viewport=It),S.toneMapping=Tt}function Zi(x,L,F){const B=L.isScene===!0?L.overrideMaterial:null;for(let D=0,it=x.length;D<it;D++){const ft=x[D],Et=ft.object,Tt=ft.geometry,It=B===null?ft.material:B,Ot=ft.group;Et.layers.test(F.layers)&&Xa(Et,L,F,Tt,It,Ot)}}function Xa(x,L,F,B,D,it){x.onBeforeRender(S,L,F,B,D,it),x.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),D.onBeforeRender(S,L,F,B,x,it),D.transparent===!0&&D.side===Fe&&D.forceSinglePass===!1?(D.side=xe,D.needsUpdate=!0,S.renderBufferDirect(F,L,B,D,x,it),D.side=Sn,D.needsUpdate=!0,S.renderBufferDirect(F,L,B,D,x,it),D.side=Fe):S.renderBufferDirect(F,L,B,D,x,it),x.onAfterRender(S,L,F,B,D,it)}function $i(x,L,F){L.isScene!==!0&&(L=Wt);const B=mt.get(x),D=h.state.lights,it=h.state.shadowsArray,ft=D.state.version,Et=yt.getParameters(x,D.state,it,L,F),Tt=yt.getProgramCacheKey(Et);let It=B.programs;B.environment=x.isMeshStandardMaterial?L.environment:null,B.fog=L.fog,B.envMap=(x.isMeshStandardMaterial?N:v).get(x.envMap||B.environment),B.envMapRotation=B.environment!==null&&x.envMap===null?L.environmentRotation:x.envMapRotation,It===void 0&&(x.addEventListener("dispose",Ft),It=new Map,B.programs=It);let Ot=It.get(Tt);if(Ot!==void 0){if(B.currentProgram===Ot&&B.lightsStateVersion===ft)return Ya(x,Et),Ot}else Et.uniforms=yt.getUniforms(x),x.onBeforeCompile(Et,S),Ot=yt.acquireProgram(Et,Tt),It.set(Tt,Ot),B.uniforms=Et.uniforms;const At=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(At.clippingPlanes=tt.uniform),Ya(x,Et),B.needsLights=ac(x),B.lightsStateVersion=ft,B.needsLights&&(At.ambientLightColor.value=D.state.ambient,At.lightProbe.value=D.state.probe,At.directionalLights.value=D.state.directional,At.directionalLightShadows.value=D.state.directionalShadow,At.spotLights.value=D.state.spot,At.spotLightShadows.value=D.state.spotShadow,At.rectAreaLights.value=D.state.rectArea,At.ltc_1.value=D.state.rectAreaLTC1,At.ltc_2.value=D.state.rectAreaLTC2,At.pointLights.value=D.state.point,At.pointLightShadows.value=D.state.pointShadow,At.hemisphereLights.value=D.state.hemi,At.directionalShadowMap.value=D.state.directionalShadowMap,At.directionalShadowMatrix.value=D.state.directionalShadowMatrix,At.spotShadowMap.value=D.state.spotShadowMap,At.spotLightMatrix.value=D.state.spotLightMatrix,At.spotLightMap.value=D.state.spotLightMap,At.pointShadowMap.value=D.state.pointShadowMap,At.pointShadowMatrix.value=D.state.pointShadowMatrix),B.currentProgram=Ot,B.uniformsList=null,Ot}function qa(x){if(x.uniformsList===null){const L=x.currentProgram.getUniforms();x.uniformsList=Dr.seqWithValue(L.seq,x.uniforms)}return x.uniformsList}function Ya(x,L){const F=mt.get(x);F.outputColorSpace=L.outputColorSpace,F.batching=L.batching,F.batchingColor=L.batchingColor,F.instancing=L.instancing,F.instancingColor=L.instancingColor,F.instancingMorph=L.instancingMorph,F.skinning=L.skinning,F.morphTargets=L.morphTargets,F.morphNormals=L.morphNormals,F.morphColors=L.morphColors,F.morphTargetsCount=L.morphTargetsCount,F.numClippingPlanes=L.numClippingPlanes,F.numIntersection=L.numClipIntersection,F.vertexAlphas=L.vertexAlphas,F.vertexTangents=L.vertexTangents,F.toneMapping=L.toneMapping}function rc(x,L,F,B,D){L.isScene!==!0&&(L=Wt),y.resetTextureUnits();const it=L.fog,ft=B.isMeshStandardMaterial?L.environment:null,Et=I===null?S.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:xi,Tt=(B.isMeshStandardMaterial?N:v).get(B.envMap||ft),It=B.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,Ot=!!F.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),At=!!F.morphAttributes.position,qt=!!F.morphAttributes.normal,Qt=!!F.morphAttributes.color;let te=Mn;B.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(te=S.toneMapping);const _e=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,Zt=_e!==void 0?_e.length:0,wt=mt.get(B),Ke=h.state.lights;if(nt===!0&&(St===!0||x!==M)){const Ae=x===M&&B.id===T;tt.setState(B,x,Ae)}let $t=!1;B.version===wt.__version?(wt.needsLights&&wt.lightsStateVersion!==Ke.state.version||wt.outputColorSpace!==Et||D.isBatchedMesh&&wt.batching===!1||!D.isBatchedMesh&&wt.batching===!0||D.isBatchedMesh&&wt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&wt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&wt.instancing===!1||!D.isInstancedMesh&&wt.instancing===!0||D.isSkinnedMesh&&wt.skinning===!1||!D.isSkinnedMesh&&wt.skinning===!0||D.isInstancedMesh&&wt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&wt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&wt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&wt.instancingMorph===!1&&D.morphTexture!==null||wt.envMap!==Tt||B.fog===!0&&wt.fog!==it||wt.numClippingPlanes!==void 0&&(wt.numClippingPlanes!==tt.numPlanes||wt.numIntersection!==tt.numIntersection)||wt.vertexAlphas!==It||wt.vertexTangents!==Ot||wt.morphTargets!==At||wt.morphNormals!==qt||wt.morphColors!==Qt||wt.toneMapping!==te||wt.morphTargetsCount!==Zt)&&($t=!0):($t=!0,wt.__version=B.version);let De=wt.currentProgram;$t===!0&&(De=$i(B,L,D));let Gn=!1,Se=!1,Ei=!1;const ee=De.getUniforms(),Ve=wt.uniforms;if(st.useProgram(De.program)&&(Gn=!0,Se=!0,Ei=!0),B.id!==T&&(T=B.id,Se=!0),Gn||M!==x){st.buffers.depth.getReversed()?(rt.copy(x.projectionMatrix),jc(rt),Qc(rt),ee.setValue(b,"projectionMatrix",rt)):ee.setValue(b,"projectionMatrix",x.projectionMatrix),ee.setValue(b,"viewMatrix",x.matrixWorldInverse);const un=ee.map.cameraPosition;un!==void 0&&un.setValue(b,Ut.setFromMatrixPosition(x.matrixWorld)),_t.logarithmicDepthBuffer&&ee.setValue(b,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&ee.setValue(b,"isOrthographic",x.isOrthographicCamera===!0),M!==x&&(M=x,Se=!0,Ei=!0)}if(D.isSkinnedMesh){ee.setOptional(b,D,"bindMatrix"),ee.setOptional(b,D,"bindMatrixInverse");const Ae=D.skeleton;Ae&&(Ae.boneTexture===null&&Ae.computeBoneTexture(),ee.setValue(b,"boneTexture",Ae.boneTexture,y))}D.isBatchedMesh&&(ee.setOptional(b,D,"batchingTexture"),ee.setValue(b,"batchingTexture",D._matricesTexture,y),ee.setOptional(b,D,"batchingIdTexture"),ee.setValue(b,"batchingIdTexture",D._indirectTexture,y),ee.setOptional(b,D,"batchingColorTexture"),D._colorsTexture!==null&&ee.setValue(b,"batchingColorTexture",D._colorsTexture,y));const Ti=F.morphAttributes;if((Ti.position!==void 0||Ti.normal!==void 0||Ti.color!==void 0)&&Dt.update(D,F,De),(Se||wt.receiveShadow!==D.receiveShadow)&&(wt.receiveShadow=D.receiveShadow,ee.setValue(b,"receiveShadow",D.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(Ve.envMap.value=Tt,Ve.flipEnvMap.value=Tt.isCubeTexture&&Tt.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&L.environment!==null&&(Ve.envMapIntensity.value=L.environmentIntensity),Se&&(ee.setValue(b,"toneMappingExposure",S.toneMappingExposure),wt.needsLights&&sc(Ve,Ei),it&&B.fog===!0&&lt.refreshFogUniforms(Ve,it),lt.refreshMaterialUniforms(Ve,B,V,j,h.state.transmissionRenderTarget[x.id]),Dr.upload(b,qa(wt),Ve,y)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Dr.upload(b,qa(wt),Ve,y),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&ee.setValue(b,"center",D.center),ee.setValue(b,"modelViewMatrix",D.modelViewMatrix),ee.setValue(b,"normalMatrix",D.normalMatrix),ee.setValue(b,"modelMatrix",D.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const Ae=B.uniformsGroups;for(let un=0,hn=Ae.length;un<hn;un++){const Za=Ae[un];P.update(Za,De),P.bind(Za,De)}}return De}function sc(x,L){x.ambientLightColor.needsUpdate=L,x.lightProbe.needsUpdate=L,x.directionalLights.needsUpdate=L,x.directionalLightShadows.needsUpdate=L,x.pointLights.needsUpdate=L,x.pointLightShadows.needsUpdate=L,x.spotLights.needsUpdate=L,x.spotLightShadows.needsUpdate=L,x.rectAreaLights.needsUpdate=L,x.hemisphereLights.needsUpdate=L}function ac(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(x,L,F){mt.get(x.texture).__webglTexture=L,mt.get(x.depthTexture).__webglTexture=F;const B=mt.get(x);B.__hasExternalTextures=!0,B.__autoAllocateDepthBuffer=F===void 0,B.__autoAllocateDepthBuffer||Q.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),B.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(x,L){const F=mt.get(x);F.__webglFramebuffer=L,F.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(x,L=0,F=0){I=x,C=L,R=F;let B=!0,D=null,it=!1,ft=!1;if(x){const Tt=mt.get(x);if(Tt.__useDefaultFramebuffer!==void 0)st.bindFramebuffer(b.FRAMEBUFFER,null),B=!1;else if(Tt.__webglFramebuffer===void 0)y.setupRenderTarget(x);else if(Tt.__hasExternalTextures)y.rebindTextures(x,mt.get(x.texture).__webglTexture,mt.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const At=x.depthTexture;if(Tt.__boundDepthTexture!==At){if(At!==null&&mt.has(At)&&(x.width!==At.image.width||x.height!==At.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(x)}}const It=x.texture;(It.isData3DTexture||It.isDataArrayTexture||It.isCompressedArrayTexture)&&(ft=!0);const Ot=mt.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Ot[L])?D=Ot[L][F]:D=Ot[L],it=!0):x.samples>0&&y.useMultisampledRTT(x)===!1?D=mt.get(x).__webglMultisampledFramebuffer:Array.isArray(Ot)?D=Ot[F]:D=Ot,w.copy(x.viewport),W.copy(x.scissor),z=x.scissorTest}else w.copy(Mt).multiplyScalar(V).floor(),W.copy(Nt).multiplyScalar(V).floor(),z=Yt;if(st.bindFramebuffer(b.FRAMEBUFFER,D)&&B&&st.drawBuffers(x,D),st.viewport(w),st.scissor(W),st.setScissorTest(z),it){const Tt=mt.get(x.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+L,Tt.__webglTexture,F)}else if(ft){const Tt=mt.get(x.texture),It=L||0;b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,Tt.__webglTexture,F||0,It)}T=-1},this.readRenderTargetPixels=function(x,L,F,B,D,it,ft){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=mt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(Et=Et[ft]),Et){st.bindFramebuffer(b.FRAMEBUFFER,Et);try{const Tt=x.texture,It=Tt.format,Ot=Tt.type;if(!_t.textureFormatReadable(It)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!_t.textureTypeReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=x.width-B&&F>=0&&F<=x.height-D&&b.readPixels(L,F,B,D,zt.convert(It),zt.convert(Ot),it)}finally{const Tt=I!==null?mt.get(I).__webglFramebuffer:null;st.bindFramebuffer(b.FRAMEBUFFER,Tt)}}},this.readRenderTargetPixelsAsync=async function(x,L,F,B,D,it,ft){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=mt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(Et=Et[ft]),Et){const Tt=x.texture,It=Tt.format,Ot=Tt.type;if(!_t.textureFormatReadable(It))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!_t.textureTypeReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=x.width-B&&F>=0&&F<=x.height-D){st.bindFramebuffer(b.FRAMEBUFFER,Et);const At=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,At),b.bufferData(b.PIXEL_PACK_BUFFER,it.byteLength,b.STREAM_READ),b.readPixels(L,F,B,D,zt.convert(It),zt.convert(Ot),0);const qt=I!==null?mt.get(I).__webglFramebuffer:null;st.bindFramebuffer(b.FRAMEBUFFER,qt);const Qt=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await Jc(b,Qt,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,At),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,it),b.deleteBuffer(At),b.deleteSync(Qt),it}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(x,L=null,F=0){x.isTexture!==!0&&(Li("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,x=arguments[1]);const B=Math.pow(2,-F),D=Math.floor(x.image.width*B),it=Math.floor(x.image.height*B),ft=L!==null?L.x:0,Et=L!==null?L.y:0;y.setTexture2D(x,0),b.copyTexSubImage2D(b.TEXTURE_2D,F,0,0,ft,Et,D,it),st.unbindTexture()},this.copyTextureToTexture=function(x,L,F=null,B=null,D=0){x.isTexture!==!0&&(Li("WebGLRenderer: copyTextureToTexture function signature has changed."),B=arguments[0]||null,x=arguments[1],L=arguments[2],D=arguments[3]||0,F=null);let it,ft,Et,Tt,It,Ot,At,qt,Qt;const te=x.isCompressedTexture?x.mipmaps[D]:x.image;F!==null?(it=F.max.x-F.min.x,ft=F.max.y-F.min.y,Et=F.isBox3?F.max.z-F.min.z:1,Tt=F.min.x,It=F.min.y,Ot=F.isBox3?F.min.z:0):(it=te.width,ft=te.height,Et=te.depth||1,Tt=0,It=0,Ot=0),B!==null?(At=B.x,qt=B.y,Qt=B.z):(At=0,qt=0,Qt=0);const _e=zt.convert(L.format),Zt=zt.convert(L.type);let wt;L.isData3DTexture?(y.setTexture3D(L,0),wt=b.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(y.setTexture2DArray(L,0),wt=b.TEXTURE_2D_ARRAY):(y.setTexture2D(L,0),wt=b.TEXTURE_2D),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,L.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,L.unpackAlignment);const Ke=b.getParameter(b.UNPACK_ROW_LENGTH),$t=b.getParameter(b.UNPACK_IMAGE_HEIGHT),De=b.getParameter(b.UNPACK_SKIP_PIXELS),Gn=b.getParameter(b.UNPACK_SKIP_ROWS),Se=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,te.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,te.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Tt),b.pixelStorei(b.UNPACK_SKIP_ROWS,It),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Ot);const Ei=x.isDataArrayTexture||x.isData3DTexture,ee=L.isDataArrayTexture||L.isData3DTexture;if(x.isRenderTargetTexture||x.isDepthTexture){const Ve=mt.get(x),Ti=mt.get(L),Ae=mt.get(Ve.__renderTarget),un=mt.get(Ti.__renderTarget);st.bindFramebuffer(b.READ_FRAMEBUFFER,Ae.__webglFramebuffer),st.bindFramebuffer(b.DRAW_FRAMEBUFFER,un.__webglFramebuffer);for(let hn=0;hn<Et;hn++)Ei&&b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,mt.get(x).__webglTexture,D,Ot+hn),x.isDepthTexture?(ee&&b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,mt.get(L).__webglTexture,D,Qt+hn),b.blitFramebuffer(Tt,It,it,ft,At,qt,it,ft,b.DEPTH_BUFFER_BIT,b.NEAREST)):ee?b.copyTexSubImage3D(wt,D,At,qt,Qt+hn,Tt,It,it,ft):b.copyTexSubImage2D(wt,D,At,qt,Qt+hn,Tt,It,it,ft);st.bindFramebuffer(b.READ_FRAMEBUFFER,null),st.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else ee?x.isDataTexture||x.isData3DTexture?b.texSubImage3D(wt,D,At,qt,Qt,it,ft,Et,_e,Zt,te.data):L.isCompressedArrayTexture?b.compressedTexSubImage3D(wt,D,At,qt,Qt,it,ft,Et,_e,te.data):b.texSubImage3D(wt,D,At,qt,Qt,it,ft,Et,_e,Zt,te):x.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,D,At,qt,it,ft,_e,Zt,te.data):x.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,D,At,qt,te.width,te.height,_e,te.data):b.texSubImage2D(b.TEXTURE_2D,D,At,qt,it,ft,_e,Zt,te);b.pixelStorei(b.UNPACK_ROW_LENGTH,Ke),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,$t),b.pixelStorei(b.UNPACK_SKIP_PIXELS,De),b.pixelStorei(b.UNPACK_SKIP_ROWS,Gn),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Se),D===0&&L.generateMipmaps&&b.generateMipmap(wt),st.unbindTexture()},this.copyTextureToTexture3D=function(x,L,F=null,B=null,D=0){return x.isTexture!==!0&&(Li("WebGLRenderer: copyTextureToTexture3D function signature has changed."),F=arguments[0]||null,B=arguments[1]||null,x=arguments[2],L=arguments[3],D=arguments[4]||0),Li('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(x,L,F,B,D)},this.initRenderTarget=function(x){mt.get(x).__webglFramebuffer===void 0&&y.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?y.setTextureCube(x,0):x.isData3DTexture?y.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?y.setTexture2DArray(x,0):y.setTexture2D(x,0),st.unbindTexture()},this.resetState=function(){C=0,R=0,I=null,st.reset(),jt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=Xt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Xt._getUnpackColorSpace()}}class hm extends ge{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new cn,this.environmentIntensity=1,this.environmentRotation=new cn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class Wl extends Xi{static get type(){return"LineBasicMaterial"}constructor(t){super(),this.isLineBasicMaterial=!0,this.color=new Gt(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}}const Nr=new U,Fr=new U,Yo=new ne,Pi=new Ua,_r=new Wr,bs=new U,Zo=new U;class fm extends ge{constructor(t=new Ye,e=new Wl){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[0];for(let r=1,s=e.count;r<s;r++)Nr.fromBufferAttribute(e,r-1),Fr.fromBufferAttribute(e,r),n[r]=n[r-1],n[r]+=Nr.distanceTo(Fr);t.setAttribute("lineDistance",new Pe(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){const n=this.geometry,r=this.matrixWorld,s=t.params.Line.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),_r.copy(n.boundingSphere),_r.applyMatrix4(r),_r.radius+=s,t.ray.intersectsSphere(_r)===!1)return;Yo.copy(r).invert(),Pi.copy(t.ray).applyMatrix4(Yo);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=this.isLineSegments?2:1,u=n.index,f=n.attributes.position;if(u!==null){const m=Math.max(0,a.start),g=Math.min(u.count,a.start+a.count);for(let _=m,p=g-1;_<p;_+=c){const h=u.getX(_),A=u.getX(_+1),E=vr(this,t,Pi,l,h,A);E&&e.push(E)}if(this.isLineLoop){const _=u.getX(g-1),p=u.getX(m),h=vr(this,t,Pi,l,_,p);h&&e.push(h)}}else{const m=Math.max(0,a.start),g=Math.min(f.count,a.start+a.count);for(let _=m,p=g-1;_<p;_+=c){const h=vr(this,t,Pi,l,_,_+1);h&&e.push(h)}if(this.isLineLoop){const _=vr(this,t,Pi,l,g-1,m);_&&e.push(_)}}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const r=e[n[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,a=r.length;s<a;s++){const o=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}function vr(i,t,e,n,r,s){const a=i.geometry.attributes.position;if(Nr.fromBufferAttribute(a,r),Fr.fromBufferAttribute(a,s),e.distanceSqToSegment(Nr,Fr,bs,Zo)>n)return;bs.applyMatrix4(i.matrixWorld);const l=t.ray.origin.distanceTo(bs);if(!(l<t.near||l>t.far))return{distance:l,point:Zo.clone().applyMatrix4(i.matrixWorld),index:r,face:null,faceIndex:null,barycoord:null,object:i}}const $o=new U,Ko=new U;class dm extends fm{constructor(t,e){super(t,e),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[];for(let r=0,s=e.count;r<s;r+=2)$o.fromBufferAttribute(e,r),Ko.fromBufferAttribute(e,r+1),n[r]=r===0?0:n[r-1],n[r+1]=n[r]+$o.distanceTo(Ko);t.setAttribute("lineDistance",new Pe(n,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class Ze{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let n,r=this.getPoint(0),s=0;e.push(0);for(let a=1;a<=t;a++)n=this.getPoint(a/t),s+=n.distanceTo(r),e.push(s),r=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const n=this.getLengths();let r=0;const s=n.length;let a;e?a=e:a=t*n[s-1];let o=0,l=s-1,c;for(;o<=l;)if(r=Math.floor(o+(l-o)/2),c=n[r]-a,c<0)o=r+1;else if(c>0)l=r-1;else{l=r;break}if(r=l,n[r]===a)return r/(s-1);const u=n[r],f=n[r+1]-u,m=(a-u)/f;return(r+m)/(s-1)}getTangent(t,e){let r=t-1e-4,s=t+1e-4;r<0&&(r=0),s>1&&(s=1);const a=this.getPoint(r),o=this.getPoint(s),l=e||(a.isVector2?new ut:new U);return l.copy(o).sub(a).normalize(),l}getTangentAt(t,e){const n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){const n=new U,r=[],s=[],a=[],o=new U,l=new ne;for(let m=0;m<=t;m++){const g=m/t;r[m]=this.getTangentAt(g,new U)}s[0]=new U,a[0]=new U;let c=Number.MAX_VALUE;const u=Math.abs(r[0].x),d=Math.abs(r[0].y),f=Math.abs(r[0].z);u<=c&&(c=u,n.set(1,0,0)),d<=c&&(c=d,n.set(0,1,0)),f<=c&&n.set(0,0,1),o.crossVectors(r[0],n).normalize(),s[0].crossVectors(r[0],o),a[0].crossVectors(r[0],s[0]);for(let m=1;m<=t;m++){if(s[m]=s[m-1].clone(),a[m]=a[m-1].clone(),o.crossVectors(r[m-1],r[m]),o.length()>Number.EPSILON){o.normalize();const g=Math.acos(de(r[m-1].dot(r[m]),-1,1));s[m].applyMatrix4(l.makeRotationAxis(o,g))}a[m].crossVectors(r[m],s[m])}if(e===!0){let m=Math.acos(de(s[0].dot(s[t]),-1,1));m/=t,r[0].dot(o.crossVectors(s[0],s[t]))>0&&(m=-m);for(let g=1;g<=t;g++)s[g].applyMatrix4(l.makeRotationAxis(r[g],m*g)),a[g].crossVectors(r[g],s[g])}return{tangents:r,normals:s,binormals:a}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class Fa extends Ze{constructor(t=0,e=0,n=1,r=1,s=0,a=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=a,this.aClockwise=o,this.aRotation=l}getPoint(t,e=new ut){const n=e,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const a=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(a?s=0:s=r),this.aClockwise===!0&&!a&&(s===r?s=-r:s=s-r);const o=this.aStartAngle+t*s;let l=this.aX+this.xRadius*Math.cos(o),c=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const u=Math.cos(this.aRotation),d=Math.sin(this.aRotation),f=l-this.aX,m=c-this.aY;l=f*u-m*d+this.aX,c=f*d+m*u+this.aY}return n.set(l,c)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class pm extends Fa{constructor(t,e,n,r,s,a){super(t,e,n,n,r,s,a),this.isArcCurve=!0,this.type="ArcCurve"}}function Oa(){let i=0,t=0,e=0,n=0;function r(s,a,o,l){i=s,t=o,e=-3*s+3*a-2*o-l,n=2*s-2*a+o+l}return{initCatmullRom:function(s,a,o,l,c){r(a,o,c*(o-s),c*(l-a))},initNonuniformCatmullRom:function(s,a,o,l,c,u,d){let f=(a-s)/c-(o-s)/(c+u)+(o-a)/u,m=(o-a)/u-(l-a)/(u+d)+(l-o)/d;f*=u,m*=u,r(a,o,f,m)},calc:function(s){const a=s*s,o=a*s;return i+t*s+e*a+n*o}}}const xr=new U,ws=new Oa,Rs=new Oa,Cs=new Oa;class mm extends Ze{constructor(t=[],e=!1,n="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=r}getPoint(t,e=new U){const n=e,r=this.points,s=r.length,a=(s-(this.closed?0:1))*t;let o=Math.floor(a),l=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/s)+1)*s:l===0&&o===s-1&&(o=s-2,l=1);let c,u;this.closed||o>0?c=r[(o-1)%s]:(xr.subVectors(r[0],r[1]).add(r[0]),c=xr);const d=r[o%s],f=r[(o+1)%s];if(this.closed||o+2<s?u=r[(o+2)%s]:(xr.subVectors(r[s-1],r[s-2]).add(r[s-1]),u=xr),this.curveType==="centripetal"||this.curveType==="chordal"){const m=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(d),m),_=Math.pow(d.distanceToSquared(f),m),p=Math.pow(f.distanceToSquared(u),m);_<1e-4&&(_=1),g<1e-4&&(g=_),p<1e-4&&(p=_),ws.initNonuniformCatmullRom(c.x,d.x,f.x,u.x,g,_,p),Rs.initNonuniformCatmullRom(c.y,d.y,f.y,u.y,g,_,p),Cs.initNonuniformCatmullRom(c.z,d.z,f.z,u.z,g,_,p)}else this.curveType==="catmullrom"&&(ws.initCatmullRom(c.x,d.x,f.x,u.x,this.tension),Rs.initCatmullRom(c.y,d.y,f.y,u.y,this.tension),Cs.initCatmullRom(c.z,d.z,f.z,u.z,this.tension));return n.set(ws.calc(l),Rs.calc(l),Cs.calc(l)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const r=t.points[e];this.points.push(r.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const r=this.points[e];t.points.push(r.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const r=t.points[e];this.points.push(new U().fromArray(r))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Jo(i,t,e,n,r){const s=(n-t)*.5,a=(r-e)*.5,o=i*i,l=i*o;return(2*e-2*n+s+a)*l+(-3*e+3*n-2*s-a)*o+s*i+e}function gm(i,t){const e=1-i;return e*e*t}function _m(i,t){return 2*(1-i)*i*t}function vm(i,t){return i*i*t}function Ui(i,t,e,n){return gm(i,t)+_m(i,e)+vm(i,n)}function xm(i,t){const e=1-i;return e*e*e*t}function Mm(i,t){const e=1-i;return 3*e*e*i*t}function Sm(i,t){return 3*(1-i)*i*i*t}function ym(i,t){return i*i*i*t}function Ii(i,t,e,n,r){return xm(i,t)+Mm(i,e)+Sm(i,n)+ym(i,r)}class Xl extends Ze{constructor(t=new ut,e=new ut,n=new ut,r=new ut){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=r}getPoint(t,e=new ut){const n=e,r=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Ii(t,r.x,s.x,a.x,o.x),Ii(t,r.y,s.y,a.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Em extends Ze{constructor(t=new U,e=new U,n=new U,r=new U){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=r}getPoint(t,e=new U){const n=e,r=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Ii(t,r.x,s.x,a.x,o.x),Ii(t,r.y,s.y,a.y,o.y),Ii(t,r.z,s.z,a.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class ql extends Ze{constructor(t=new ut,e=new ut){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new ut){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new ut){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Tm extends Ze{constructor(t=new U,e=new U){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new U){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new U){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Yl extends Ze{constructor(t=new ut,e=new ut,n=new ut){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new ut){const n=e,r=this.v0,s=this.v1,a=this.v2;return n.set(Ui(t,r.x,s.x,a.x),Ui(t,r.y,s.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Am extends Ze{constructor(t=new U,e=new U,n=new U){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new U){const n=e,r=this.v0,s=this.v1,a=this.v2;return n.set(Ui(t,r.x,s.x,a.x),Ui(t,r.y,s.y,a.y),Ui(t,r.z,s.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Zl extends Ze{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new ut){const n=e,r=this.points,s=(r.length-1)*t,a=Math.floor(s),o=s-a,l=r[a===0?a:a-1],c=r[a],u=r[a>r.length-2?r.length-1:a+1],d=r[a>r.length-3?r.length-1:a+2];return n.set(Jo(o,l.x,c.x,u.x,d.x),Jo(o,l.y,c.y,u.y,d.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const r=t.points[e];this.points.push(r.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const r=this.points[e];t.points.push(r.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const r=t.points[e];this.points.push(new ut().fromArray(r))}return this}}var Sa=Object.freeze({__proto__:null,ArcCurve:pm,CatmullRomCurve3:mm,CubicBezierCurve:Xl,CubicBezierCurve3:Em,EllipseCurve:Fa,LineCurve:ql,LineCurve3:Tm,QuadraticBezierCurve:Yl,QuadraticBezierCurve3:Am,SplineCurve:Zl});class bm extends Ze{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new Sa[n](e,t))}return this}getPoint(t,e){const n=t*this.getLength(),r=this.getCurveLengths();let s=0;for(;s<r.length;){if(r[s]>=n){const a=r[s]-n,o=this.curves[s],l=o.getLength(),c=l===0?0:1-a/l;return o.getPointAt(c,e)}s++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let n=0,r=this.curves.length;n<r;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let n;for(let r=0,s=this.curves;r<s.length;r++){const a=s[r],o=a.isEllipseCurve?t*2:a.isLineCurve||a.isLineCurve3?1:a.isSplineCurve?t*a.points.length:t,l=a.getPoints(o);for(let c=0;c<l.length;c++){const u=l[c];n&&n.equals(u)||(e.push(u),n=u)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const r=t.curves[e];this.curves.push(r.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){const r=this.curves[e];t.curves.push(r.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const r=t.curves[e];this.curves.push(new Sa[r.type]().fromJSON(r))}return this}}class ya extends bm{constructor(t){super(),this.type="Path",this.currentPoint=new ut,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const n=new ql(this.currentPoint.clone(),new ut(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,r){const s=new Yl(this.currentPoint.clone(),new ut(t,e),new ut(n,r));return this.curves.push(s),this.currentPoint.set(n,r),this}bezierCurveTo(t,e,n,r,s,a){const o=new Xl(this.currentPoint.clone(),new ut(t,e),new ut(n,r),new ut(s,a));return this.curves.push(o),this.currentPoint.set(s,a),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),n=new Zl(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,r,s,a){const o=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(t+o,e+l,n,r,s,a),this}absarc(t,e,n,r,s,a){return this.absellipse(t,e,n,n,r,s,a),this}ellipse(t,e,n,r,s,a,o,l){const c=this.currentPoint.x,u=this.currentPoint.y;return this.absellipse(t+c,e+u,n,r,s,a,o,l),this}absellipse(t,e,n,r,s,a,o,l){const c=new Fa(t,e,n,r,s,a,o,l);if(this.curves.length>0){const d=c.getPoint(0);d.equals(this.currentPoint)||this.lineTo(d.x,d.y)}this.curves.push(c);const u=c.getPoint(1);return this.currentPoint.copy(u),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}const Mr=new U,Sr=new U,Ps=new U,yr=new Ce;class wm extends Ye{constructor(t=null,e=1){if(super(),this.type="EdgesGeometry",this.parameters={geometry:t,thresholdAngle:e},t!==null){const r=Math.pow(10,4),s=Math.cos(Lr*e),a=t.getIndex(),o=t.getAttribute("position"),l=a?a.count:o.count,c=[0,0,0],u=["a","b","c"],d=new Array(3),f={},m=[];for(let g=0;g<l;g+=3){a?(c[0]=a.getX(g),c[1]=a.getX(g+1),c[2]=a.getX(g+2)):(c[0]=g,c[1]=g+1,c[2]=g+2);const{a:_,b:p,c:h}=yr;if(_.fromBufferAttribute(o,c[0]),p.fromBufferAttribute(o,c[1]),h.fromBufferAttribute(o,c[2]),yr.getNormal(Ps),d[0]=`${Math.round(_.x*r)},${Math.round(_.y*r)},${Math.round(_.z*r)}`,d[1]=`${Math.round(p.x*r)},${Math.round(p.y*r)},${Math.round(p.z*r)}`,d[2]=`${Math.round(h.x*r)},${Math.round(h.y*r)},${Math.round(h.z*r)}`,!(d[0]===d[1]||d[1]===d[2]||d[2]===d[0]))for(let A=0;A<3;A++){const E=(A+1)%3,S=d[A],O=d[E],C=yr[u[A]],R=yr[u[E]],I=`${S}_${O}`,T=`${O}_${S}`;T in f&&f[T]?(Ps.dot(f[T].normal)<=s&&(m.push(C.x,C.y,C.z),m.push(R.x,R.y,R.z)),f[T]=null):I in f||(f[I]={index0:c[A],index1:c[E],normal:Ps.clone()})}}for(const g in f)if(f[g]){const{index0:_,index1:p}=f[g];Mr.fromBufferAttribute(o,_),Sr.fromBufferAttribute(o,p),m.push(Mr.x,Mr.y,Mr.z),m.push(Sr.x,Sr.y,Sr.z)}this.setAttribute("position",new Pe(m,3))}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}class $l extends ya{constructor(t){super(t),this.uuid=Si(),this.type="Shape",this.holes=[]}getPointsHoles(t){const e=[];for(let n=0,r=this.holes.length;n<r;n++)e[n]=this.holes[n].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const r=t.holes[e];this.holes.push(r.clone())}return this}toJSON(){const t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,n=this.holes.length;e<n;e++){const r=this.holes[e];t.holes.push(r.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const r=t.holes[e];this.holes.push(new ya().fromJSON(r))}return this}}const Rm={triangulate:function(i,t,e=2){const n=t&&t.length,r=n?t[0]*e:i.length;let s=Kl(i,0,r,e,!0);const a=[];if(!s||s.next===s.prev)return a;let o,l,c,u,d,f,m;if(n&&(s=Um(i,t,s,e)),i.length>80*e){o=c=i[0],l=u=i[1];for(let g=e;g<r;g+=e)d=i[g],f=i[g+1],d<o&&(o=d),f<l&&(l=f),d>c&&(c=d),f>u&&(u=f);m=Math.max(c-o,u-l),m=m!==0?32767/m:0}return Bi(s,a,e,o,l,m,0),a}};function Kl(i,t,e,n,r){let s,a;if(r===Wm(i,t,e,n)>0)for(s=t;s<e;s+=n)a=jo(s,i[s],i[s+1],a);else for(s=e-n;s>=t;s-=n)a=jo(s,i[s],i[s+1],a);return a&&Zr(a,a.next)&&(Hi(a),a=a.next),a}function Hn(i,t){if(!i)return i;t||(t=i);let e=i,n;do if(n=!1,!e.steiner&&(Zr(e,e.next)||ie(e.prev,e,e.next)===0)){if(Hi(e),e=t=e.prev,e===e.next)break;n=!0}else e=e.next;while(n||e!==t);return t}function Bi(i,t,e,n,r,s,a){if(!i)return;!a&&s&&Bm(i,n,r,s);let o=i,l,c;for(;i.prev!==i.next;){if(l=i.prev,c=i.next,s?Pm(i,n,r,s):Cm(i)){t.push(l.i/e|0),t.push(i.i/e|0),t.push(c.i/e|0),Hi(i),i=c.next,o=c.next;continue}if(i=c,i===o){a?a===1?(i=Lm(Hn(i),t,e),Bi(i,t,e,n,r,s,2)):a===2&&Dm(i,t,e,n,r,s):Bi(Hn(i),t,e,n,r,s,1);break}}}function Cm(i){const t=i.prev,e=i,n=i.next;if(ie(t,e,n)>=0)return!1;const r=t.x,s=e.x,a=n.x,o=t.y,l=e.y,c=n.y,u=r<s?r<a?r:a:s<a?s:a,d=o<l?o<c?o:c:l<c?l:c,f=r>s?r>a?r:a:s>a?s:a,m=o>l?o>c?o:c:l>c?l:c;let g=n.next;for(;g!==t;){if(g.x>=u&&g.x<=f&&g.y>=d&&g.y<=m&&ai(r,o,s,l,a,c,g.x,g.y)&&ie(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function Pm(i,t,e,n){const r=i.prev,s=i,a=i.next;if(ie(r,s,a)>=0)return!1;const o=r.x,l=s.x,c=a.x,u=r.y,d=s.y,f=a.y,m=o<l?o<c?o:c:l<c?l:c,g=u<d?u<f?u:f:d<f?d:f,_=o>l?o>c?o:c:l>c?l:c,p=u>d?u>f?u:f:d>f?d:f,h=Ea(m,g,t,e,n),A=Ea(_,p,t,e,n);let E=i.prevZ,S=i.nextZ;for(;E&&E.z>=h&&S&&S.z<=A;){if(E.x>=m&&E.x<=_&&E.y>=g&&E.y<=p&&E!==r&&E!==a&&ai(o,u,l,d,c,f,E.x,E.y)&&ie(E.prev,E,E.next)>=0||(E=E.prevZ,S.x>=m&&S.x<=_&&S.y>=g&&S.y<=p&&S!==r&&S!==a&&ai(o,u,l,d,c,f,S.x,S.y)&&ie(S.prev,S,S.next)>=0))return!1;S=S.nextZ}for(;E&&E.z>=h;){if(E.x>=m&&E.x<=_&&E.y>=g&&E.y<=p&&E!==r&&E!==a&&ai(o,u,l,d,c,f,E.x,E.y)&&ie(E.prev,E,E.next)>=0)return!1;E=E.prevZ}for(;S&&S.z<=A;){if(S.x>=m&&S.x<=_&&S.y>=g&&S.y<=p&&S!==r&&S!==a&&ai(o,u,l,d,c,f,S.x,S.y)&&ie(S.prev,S,S.next)>=0)return!1;S=S.nextZ}return!0}function Lm(i,t,e){let n=i;do{const r=n.prev,s=n.next.next;!Zr(r,s)&&Jl(r,n,n.next,s)&&zi(r,s)&&zi(s,r)&&(t.push(r.i/e|0),t.push(n.i/e|0),t.push(s.i/e|0),Hi(n),Hi(n.next),n=i=s),n=n.next}while(n!==i);return Hn(n)}function Dm(i,t,e,n,r,s){let a=i;do{let o=a.next.next;for(;o!==a.prev;){if(a.i!==o.i&&Vm(a,o)){let l=jl(a,o);a=Hn(a,a.next),l=Hn(l,l.next),Bi(a,t,e,n,r,s,0),Bi(l,t,e,n,r,s,0);return}o=o.next}a=a.next}while(a!==i)}function Um(i,t,e,n){const r=[];let s,a,o,l,c;for(s=0,a=t.length;s<a;s++)o=t[s]*n,l=s<a-1?t[s+1]*n:i.length,c=Kl(i,o,l,n,!1),c===c.next&&(c.steiner=!0),r.push(Hm(c));for(r.sort(Im),s=0;s<r.length;s++)e=Nm(r[s],e);return e}function Im(i,t){return i.x-t.x}function Nm(i,t){const e=Fm(i,t);if(!e)return t;const n=jl(e,i);return Hn(n,n.next),Hn(e,e.next)}function Fm(i,t){let e=t,n=-1/0,r;const s=i.x,a=i.y;do{if(a<=e.y&&a>=e.next.y&&e.next.y!==e.y){const f=e.x+(a-e.y)*(e.next.x-e.x)/(e.next.y-e.y);if(f<=s&&f>n&&(n=f,r=e.x<e.next.x?e:e.next,f===s))return r}e=e.next}while(e!==t);if(!r)return null;const o=r,l=r.x,c=r.y;let u=1/0,d;e=r;do s>=e.x&&e.x>=l&&s!==e.x&&ai(a<c?s:n,a,l,c,a<c?n:s,a,e.x,e.y)&&(d=Math.abs(a-e.y)/(s-e.x),zi(e,i)&&(d<u||d===u&&(e.x>r.x||e.x===r.x&&Om(r,e)))&&(r=e,u=d)),e=e.next;while(e!==o);return r}function Om(i,t){return ie(i.prev,i,t.prev)<0&&ie(t.next,i,i.next)<0}function Bm(i,t,e,n){let r=i;do r.z===0&&(r.z=Ea(r.x,r.y,t,e,n)),r.prevZ=r.prev,r.nextZ=r.next,r=r.next;while(r!==i);r.prevZ.nextZ=null,r.prevZ=null,zm(r)}function zm(i){let t,e,n,r,s,a,o,l,c=1;do{for(e=i,i=null,s=null,a=0;e;){for(a++,n=e,o=0,t=0;t<c&&(o++,n=n.nextZ,!!n);t++);for(l=c;o>0||l>0&&n;)o!==0&&(l===0||!n||e.z<=n.z)?(r=e,e=e.nextZ,o--):(r=n,n=n.nextZ,l--),s?s.nextZ=r:i=r,r.prevZ=s,s=r;e=n}s.nextZ=null,c*=2}while(a>1);return i}function Ea(i,t,e,n,r){return i=(i-e)*r|0,t=(t-n)*r|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,i|t<<1}function Hm(i){let t=i,e=i;do(t.x<e.x||t.x===e.x&&t.y<e.y)&&(e=t),t=t.next;while(t!==i);return e}function ai(i,t,e,n,r,s,a,o){return(r-a)*(t-o)>=(i-a)*(s-o)&&(i-a)*(n-o)>=(e-a)*(t-o)&&(e-a)*(s-o)>=(r-a)*(n-o)}function Vm(i,t){return i.next.i!==t.i&&i.prev.i!==t.i&&!Gm(i,t)&&(zi(i,t)&&zi(t,i)&&km(i,t)&&(ie(i.prev,i,t.prev)||ie(i,t.prev,t))||Zr(i,t)&&ie(i.prev,i,i.next)>0&&ie(t.prev,t,t.next)>0)}function ie(i,t,e){return(t.y-i.y)*(e.x-t.x)-(t.x-i.x)*(e.y-t.y)}function Zr(i,t){return i.x===t.x&&i.y===t.y}function Jl(i,t,e,n){const r=Tr(ie(i,t,e)),s=Tr(ie(i,t,n)),a=Tr(ie(e,n,i)),o=Tr(ie(e,n,t));return!!(r!==s&&a!==o||r===0&&Er(i,e,t)||s===0&&Er(i,n,t)||a===0&&Er(e,i,n)||o===0&&Er(e,t,n))}function Er(i,t,e){return t.x<=Math.max(i.x,e.x)&&t.x>=Math.min(i.x,e.x)&&t.y<=Math.max(i.y,e.y)&&t.y>=Math.min(i.y,e.y)}function Tr(i){return i>0?1:i<0?-1:0}function Gm(i,t){let e=i;do{if(e.i!==i.i&&e.next.i!==i.i&&e.i!==t.i&&e.next.i!==t.i&&Jl(e,e.next,i,t))return!0;e=e.next}while(e!==i);return!1}function zi(i,t){return ie(i.prev,i,i.next)<0?ie(i,t,i.next)>=0&&ie(i,i.prev,t)>=0:ie(i,t,i.prev)<0||ie(i,i.next,t)<0}function km(i,t){let e=i,n=!1;const r=(i.x+t.x)/2,s=(i.y+t.y)/2;do e.y>s!=e.next.y>s&&e.next.y!==e.y&&r<(e.next.x-e.x)*(s-e.y)/(e.next.y-e.y)+e.x&&(n=!n),e=e.next;while(e!==i);return n}function jl(i,t){const e=new Ta(i.i,i.x,i.y),n=new Ta(t.i,t.x,t.y),r=i.next,s=t.prev;return i.next=t,t.prev=i,e.next=r,r.prev=e,n.next=e,e.prev=n,s.next=n,n.prev=s,n}function jo(i,t,e,n){const r=new Ta(i,t,e);return n?(r.next=n.next,r.prev=n,n.next.prev=r,n.next=r):(r.prev=r,r.next=r),r}function Hi(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function Ta(i,t,e){this.i=i,this.x=t,this.y=e,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function Wm(i,t,e,n){let r=0;for(let s=t,a=e-n;s<e;s+=n)r+=(i[a]-i[s])*(i[s+1]+i[a+1]),a=s;return r}class Ni{static area(t){const e=t.length;let n=0;for(let r=e-1,s=0;s<e;r=s++)n+=t[r].x*t[s].y-t[s].x*t[r].y;return n*.5}static isClockWise(t){return Ni.area(t)<0}static triangulateShape(t,e){const n=[],r=[],s=[];Qo(t),tl(n,t);let a=t.length;e.forEach(Qo);for(let l=0;l<e.length;l++)r.push(a),a+=e[l].length,tl(n,e[l]);const o=Rm.triangulate(n,r);for(let l=0;l<o.length;l+=3)s.push(o.slice(l,l+3));return s}}function Qo(i){const t=i.length;t>2&&i[t-1].equals(i[0])&&i.pop()}function tl(i,t){for(let e=0;e<t.length;e++)i.push(t[e].x),i.push(t[e].y)}class Ba extends Ye{constructor(t=new $l([new ut(.5,.5),new ut(-.5,.5),new ut(-.5,-.5),new ut(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];const n=this,r=[],s=[];for(let o=0,l=t.length;o<l;o++){const c=t[o];a(c)}this.setAttribute("position",new Pe(r,3)),this.setAttribute("uv",new Pe(s,2)),this.computeVertexNormals();function a(o){const l=[],c=e.curveSegments!==void 0?e.curveSegments:12,u=e.steps!==void 0?e.steps:1,d=e.depth!==void 0?e.depth:1;let f=e.bevelEnabled!==void 0?e.bevelEnabled:!0,m=e.bevelThickness!==void 0?e.bevelThickness:.2,g=e.bevelSize!==void 0?e.bevelSize:m-.1,_=e.bevelOffset!==void 0?e.bevelOffset:0,p=e.bevelSegments!==void 0?e.bevelSegments:3;const h=e.extrudePath,A=e.UVGenerator!==void 0?e.UVGenerator:Xm;let E,S=!1,O,C,R,I;h&&(E=h.getSpacedPoints(u),S=!0,f=!1,O=h.computeFrenetFrames(u,!1),C=new U,R=new U,I=new U),f||(p=0,m=0,g=0,_=0);const T=o.extractPoints(c);let M=T.shape;const w=T.holes;if(!Ni.isClockWise(M)){M=M.reverse();for(let K=0,et=w.length;K<et;K++){const b=w[K];Ni.isClockWise(b)&&(w[K]=b.reverse())}}const z=Ni.triangulateShape(M,w),k=M;for(let K=0,et=w.length;K<et;K++){const b=w[K];M=M.concat(b)}function Z(K,et,b){return et||console.error("THREE.ExtrudeGeometry: vec does not exist"),K.clone().addScaledVector(et,b)}const H=M.length,j=z.length;function V(K,et,b){let bt,Q,_t;const st=K.x-et.x,Ct=K.y-et.y,mt=b.x-K.x,y=b.y-K.y,v=st*st+Ct*Ct,N=st*y-Ct*mt;if(Math.abs(N)>Number.EPSILON){const X=Math.sqrt(v),J=Math.sqrt(mt*mt+y*y),q=et.x-Ct/X,yt=et.y+st/X,lt=b.x-y/J,gt=b.y+mt/J,Vt=((lt-q)*y-(gt-yt)*mt)/(st*y-Ct*mt);bt=q+st*Vt-K.x,Q=yt+Ct*Vt-K.y;const tt=bt*bt+Q*Q;if(tt<=2)return new ut(bt,Q);_t=Math.sqrt(tt/2)}else{let X=!1;st>Number.EPSILON?mt>Number.EPSILON&&(X=!0):st<-Number.EPSILON?mt<-Number.EPSILON&&(X=!0):Math.sign(Ct)===Math.sign(y)&&(X=!0),X?(bt=-Ct,Q=st,_t=Math.sqrt(v)):(bt=st,Q=Ct,_t=Math.sqrt(v/2))}return new ut(bt/_t,Q/_t)}const at=[];for(let K=0,et=k.length,b=et-1,bt=K+1;K<et;K++,b++,bt++)b===et&&(b=0),bt===et&&(bt=0),at[K]=V(k[K],k[b],k[bt]);const pt=[];let Mt,Nt=at.concat();for(let K=0,et=w.length;K<et;K++){const b=w[K];Mt=[];for(let bt=0,Q=b.length,_t=Q-1,st=bt+1;bt<Q;bt++,_t++,st++)_t===Q&&(_t=0),st===Q&&(st=0),Mt[bt]=V(b[bt],b[_t],b[st]);pt.push(Mt),Nt=Nt.concat(Mt)}for(let K=0;K<p;K++){const et=K/p,b=m*Math.cos(et*Math.PI/2),bt=g*Math.sin(et*Math.PI/2)+_;for(let Q=0,_t=k.length;Q<_t;Q++){const st=Z(k[Q],at[Q],bt);rt(st.x,st.y,-b)}for(let Q=0,_t=w.length;Q<_t;Q++){const st=w[Q];Mt=pt[Q];for(let Ct=0,mt=st.length;Ct<mt;Ct++){const y=Z(st[Ct],Mt[Ct],bt);rt(y.x,y.y,-b)}}}const Yt=g+_;for(let K=0;K<H;K++){const et=f?Z(M[K],Nt[K],Yt):M[K];S?(R.copy(O.normals[0]).multiplyScalar(et.x),C.copy(O.binormals[0]).multiplyScalar(et.y),I.copy(E[0]).add(R).add(C),rt(I.x,I.y,I.z)):rt(et.x,et.y,0)}for(let K=1;K<=u;K++)for(let et=0;et<H;et++){const b=f?Z(M[et],Nt[et],Yt):M[et];S?(R.copy(O.normals[K]).multiplyScalar(b.x),C.copy(O.binormals[K]).multiplyScalar(b.y),I.copy(E[K]).add(R).add(C),rt(I.x,I.y,I.z)):rt(b.x,b.y,d/u*K)}for(let K=p-1;K>=0;K--){const et=K/p,b=m*Math.cos(et*Math.PI/2),bt=g*Math.sin(et*Math.PI/2)+_;for(let Q=0,_t=k.length;Q<_t;Q++){const st=Z(k[Q],at[Q],bt);rt(st.x,st.y,d+b)}for(let Q=0,_t=w.length;Q<_t;Q++){const st=w[Q];Mt=pt[Q];for(let Ct=0,mt=st.length;Ct<mt;Ct++){const y=Z(st[Ct],Mt[Ct],bt);S?rt(y.x,y.y+E[u-1].y,E[u-1].x+b):rt(y.x,y.y,d+b)}}}Y(),nt();function Y(){const K=r.length/3;if(f){let et=0,b=H*et;for(let bt=0;bt<j;bt++){const Q=z[bt];Rt(Q[2]+b,Q[1]+b,Q[0]+b)}et=u+p*2,b=H*et;for(let bt=0;bt<j;bt++){const Q=z[bt];Rt(Q[0]+b,Q[1]+b,Q[2]+b)}}else{for(let et=0;et<j;et++){const b=z[et];Rt(b[2],b[1],b[0])}for(let et=0;et<j;et++){const b=z[et];Rt(b[0]+H*u,b[1]+H*u,b[2]+H*u)}}n.addGroup(K,r.length/3-K,0)}function nt(){const K=r.length/3;let et=0;St(k,et),et+=k.length;for(let b=0,bt=w.length;b<bt;b++){const Q=w[b];St(Q,et),et+=Q.length}n.addGroup(K,r.length/3-K,1)}function St(K,et){let b=K.length;for(;--b>=0;){const bt=b;let Q=b-1;Q<0&&(Q=K.length-1);for(let _t=0,st=u+p*2;_t<st;_t++){const Ct=H*_t,mt=H*(_t+1),y=et+bt+Ct,v=et+Q+Ct,N=et+Q+mt,X=et+bt+mt;Ut(y,v,N,X)}}}function rt(K,et,b){l.push(K),l.push(et),l.push(b)}function Rt(K,et,b){Lt(K),Lt(et),Lt(b);const bt=r.length/3,Q=A.generateTopUV(n,r,bt-3,bt-2,bt-1);Wt(Q[0]),Wt(Q[1]),Wt(Q[2])}function Ut(K,et,b,bt){Lt(K),Lt(et),Lt(bt),Lt(et),Lt(b),Lt(bt);const Q=r.length/3,_t=A.generateSideWallUV(n,r,Q-6,Q-3,Q-2,Q-1);Wt(_t[0]),Wt(_t[1]),Wt(_t[3]),Wt(_t[1]),Wt(_t[2]),Wt(_t[3])}function Lt(K){r.push(l[K*3+0]),r.push(l[K*3+1]),r.push(l[K*3+2])}function Wt(K){s.push(K.x),s.push(K.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON(),e=this.parameters.shapes,n=this.parameters.options;return qm(e,n,t)}static fromJSON(t,e){const n=[];for(let s=0,a=t.shapes.length;s<a;s++){const o=e[t.shapes[s]];n.push(o)}const r=t.options.extrudePath;return r!==void 0&&(t.options.extrudePath=new Sa[r.type]().fromJSON(r)),new Ba(n,t.options)}}const Xm={generateTopUV:function(i,t,e,n,r){const s=t[e*3],a=t[e*3+1],o=t[n*3],l=t[n*3+1],c=t[r*3],u=t[r*3+1];return[new ut(s,a),new ut(o,l),new ut(c,u)]},generateSideWallUV:function(i,t,e,n,r,s){const a=t[e*3],o=t[e*3+1],l=t[e*3+2],c=t[n*3],u=t[n*3+1],d=t[n*3+2],f=t[r*3],m=t[r*3+1],g=t[r*3+2],_=t[s*3],p=t[s*3+1],h=t[s*3+2];return Math.abs(o-u)<Math.abs(a-c)?[new ut(a,1-l),new ut(c,1-d),new ut(f,1-g),new ut(_,1-h)]:[new ut(o,1-l),new ut(u,1-d),new ut(m,1-g),new ut(p,1-h)]}};function qm(i,t,e){if(e.shapes=[],Array.isArray(i))for(let n=0,r=i.length;n<r;n++){const s=i[n];e.shapes.push(s.uuid)}else e.shapes.push(i.uuid);return e.options=Object.assign({},t),t.extrudePath!==void 0&&(e.options.extrudePath=t.extrudePath.toJSON()),e}class Ym{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=el(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=el();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function el(){return performance.now()}const nl=new ne;class Zm{constructor(t,e,n=0,r=1/0){this.ray=new Ua(t,e),this.near=n,this.far=r,this.camera=null,this.layers=new Ia,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(t,e){this.ray.set(t,e)}setFromCamera(t,e){e.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(t.x,t.y,.5).unproject(e).sub(this.ray.origin).normalize(),this.camera=e):e.isOrthographicCamera?(this.ray.origin.set(t.x,t.y,(e.near+e.far)/(e.near-e.far)).unproject(e),this.ray.direction.set(0,0,-1).transformDirection(e.matrixWorld),this.camera=e):console.error("THREE.Raycaster: Unsupported camera type: "+e.type)}setFromXRController(t){return nl.identity().extractRotation(t.matrixWorld),this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(nl),this}intersectObject(t,e=!0,n=[]){return Aa(t,this,n,e),n.sort(il),n}intersectObjects(t,e=!0,n=[]){for(let r=0,s=t.length;r<s;r++)Aa(t[r],this,n,e);return n.sort(il),n}}function il(i,t){return i.distance-t.distance}function Aa(i,t,e,n){let r=!0;if(i.layers.test(t.layers)&&i.raycast(t,e)===!1&&(r=!1),r===!0&&n===!0){const s=i.children;for(let a=0,o=s.length;a<o;a++)Aa(s[a],t,e,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ba}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ba);class $m extends ge{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new ut(.5,.5),this.addEventListener("removed",function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(t,e){return super.copy(t,e),this.element=t.element.cloneNode(!0),this.center=t.center,this}}const ii=new U,rl=new ne,sl=new ne,al=new U,ol=new U;class Km{constructor(t={}){const e=this;let n,r,s,a;const o={objects:new WeakMap},l=t.element!==void 0?t.element:document.createElement("div");l.style.overflow="hidden",this.domElement=l,this.getSize=function(){return{width:n,height:r}},this.render=function(g,_){g.matrixWorldAutoUpdate===!0&&g.updateMatrixWorld(),_.parent===null&&_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),rl.copy(_.matrixWorldInverse),sl.multiplyMatrices(_.projectionMatrix,rl),u(g,g,_),m(g)},this.setSize=function(g,_){n=g,r=_,s=n/2,a=r/2,l.style.width=g+"px",l.style.height=_+"px"};function c(g){g.isCSS2DObject&&(g.element.style.display="none");for(let _=0,p=g.children.length;_<p;_++)c(g.children[_])}function u(g,_,p){if(g.visible===!1){c(g);return}if(g.isCSS2DObject){ii.setFromMatrixPosition(g.matrixWorld),ii.applyMatrix4(sl);const h=ii.z>=-1&&ii.z<=1&&g.layers.test(p.layers)===!0,A=g.element;A.style.display=h===!0?"":"none",h===!0&&(g.onBeforeRender(e,_,p),A.style.transform="translate("+-100*g.center.x+"%,"+-100*g.center.y+"%)translate("+(ii.x*s+s)+"px,"+(-ii.y*a+a)+"px)",A.parentNode!==l&&l.appendChild(A),g.onAfterRender(e,_,p));const E={distanceToCameraSquared:d(p,g)};o.objects.set(g,E)}for(let h=0,A=g.children.length;h<A;h++)u(g.children[h],_,p)}function d(g,_){return al.setFromMatrixPosition(g.matrixWorld),ol.setFromMatrixPosition(_.matrixWorld),al.distanceToSquared(ol)}function f(g){const _=[];return g.traverseVisible(function(p){p.isCSS2DObject&&_.push(p)}),_}function m(g){const _=f(g).sort(function(h,A){if(h.renderOrder!==A.renderOrder)return A.renderOrder-h.renderOrder;const E=o.objects.get(h).distanceToCameraSquared,S=o.objects.get(A).distanceToCameraSquared;return E-S}),p=_.length;for(let h=0,A=_.length;h<A;h++)_[h].element.style.zIndex=p-h}}}function ll(i){let t=0;for(let e=0,n=i.length-1;e<i.length;n=e++)t+=(i[n][0]+i[e][0])*(i[n][1]-i[e][1]);return Math.abs(t)/2}function Jm(i){const t=new Gt;return i<.5?t.lerpColors(new Gt("#1a2a6c"),new Gt("#3a7ca5"),i*2):t.lerpColors(new Gt("#3a7ca5"),new Gt("#d4a843"),(i-.5)*2),t}function jm(i){let t=0,e=0,n=0;for(let r=0,s=i.length-1;r<i.length;s=r++){const a=i[s][0]*i[r][1]-i[r][0]*i[s][1];n+=a,t+=(i[s][0]+i[r][0])*a,e+=(i[s][1]+i[r][1])*a}return n/=2,{x:t/(6*n),z:e/(6*n)}}function Qm(i,t){const e={};return i.getHSL(e),e.s=Math.min(1,Math.max(0,e.s*t)),i.setHSL(e.h,e.s,e.l)}function tg(i,t,e,n){const r=[{scale:1.008,opacity:.2},{scale:1.02,opacity:.06},{scale:1.04,opacity:.02}],s=[];for(const a of r){const o=t.clone();o.scale(a.scale,a.scale,1);const l=new Xr({color:n,transparent:!0,opacity:a.opacity,blending:Us,depthWrite:!1,side:Fe}),c=new Be(o,l);c.rotation.x=-Math.PI/2,c.scale.z=0,c.position.copy(e),i.add(c),s.push({mesh:c,material:l,baseOpacity:a.opacity})}return s}async function eg(){const e=(await(await fetch("/footprints_centered.geojson")).json()).features.filter(f=>f.geometry.type==="Polygon"),n=e.map(f=>f.properties.year),r=Math.min(...n),s=Math.max(...n),a=e.map(f=>({exterior:f.geometry.coordinates[0],area:ll(f.geometry.coordinates[0])}));a.sort((f,m)=>f.area-m.area);const o=a[Math.floor(a.length*.85)].area,l=new si,c=new Wl({color:16777215,transparent:!0,opacity:0}),u=[],d=[];for(const f of e){const m=f.geometry;if(m.type!=="Polygon")continue;const g=m.coordinates[0],_=m.coordinates.slice(1).map(Z=>Z.map(([H,j])=>new ut(H,j))),p=new $l(g.map(([Z,H])=>new ut(Z,H)));for(const Z of _)p.holes.push(new ya(Z));const h=(f.properties.year-r)/(s-r),A=f.properties.id==="NL32B_N326E397_Y2596.6553_X3343.2809"||f.properties.id==="NL32B_N326E397_Y2400.9044_X3394.3630",E=Jm(h);Qm(E,A?1.8:.75);const S=E.clone(),O=new Xr({color:0,side:Fe}),R=ll(g)>o?20+Math.random()*5:10+Math.random()*5,I={depth:R,bevelEnabled:!1},T=new Ba(p,I),M=new Be(T,O);M.rotation.x=-Math.PI/2,M.scale.z=0,l.add(M);const w=new wm(T),W=new dm(w,c);W.rotation.x=-Math.PI/2,W.scale.z=0,l.add(W);const z=Math.random()*.8,k=Math.random()<.2?2:3;if(A||u.push({mesh:M,line:W,material:O,baseColor:S,height:R,extrudeDelay:z,colorPhase:k}),A){M.visible=!1,W.visible=!1;const Z=f.properties.id==="NL32B_N326E397_Y2400.9044_X3394.3630",H=tg(l,T,M.position,Z?6719743:16746496);for(const V of H)V.mesh.visible=!1;const j=jm(g);d.push({glows:H,mesh:M,material:O,baseColor:S,line:W,height:R,centroid:j,label:Z?"Projects":"About",extrudeDelay:z})}}return{group:l,glowTargets:d,allBuildings:u}}const oi=new hm;oi.background=new Gt(0);const an=new Re(45,window.innerWidth/window.innerHeight,.1,5e3);an.position.set(0,280,540);an.lookAt(0,0,0);const En=new um({antialias:!0});En.setSize(window.innerWidth,window.innerHeight);En.setPixelRatio(Math.min(window.devicePixelRatio,2));document.body.appendChild(En.domElement);const qe=new Km;qe.setSize(window.innerWidth,window.innerHeight);qe.domElement.style.position="absolute";qe.domElement.style.top="0";qe.domElement.style.left="0";qe.domElement.style.zIndex="10";qe.domElement.style.pointerEvents="none";document.body.appendChild(qe.domElement);window.addEventListener("resize",()=>{an.aspect=window.innerWidth/window.innerHeight,an.updateProjectionMatrix(),En.setSize(window.innerWidth,window.innerHeight),qe.setSize(window.innerWidth,window.innerHeight)});const pe={EDGES:1,SAMPLE_20:2,ALL_COLOR:3,EXTRUDE:4,GLOW:5},Te={start:[0,.8,2.5,5,7.5,10],dur:[0,1.5,.1,1.8,1.5,2]};function Ar(i){return Te.start[i]+Te.dur[i]}const $r=new si;oi.add($r);const{group:ng,glowTargets:hi,allBuildings:Ln}=await eg();$r.add(ng);const Vi=[];for(const i of hi){const t=document.createElement("div");t.textContent=i.label,t.style.color="#fff",t.style.fontFamily="monospace",t.style.fontSize="14px",t.style.fontWeight="900",t.style.webkitTextStroke="2.5px #000",t.style.paintOrder="stroke fill",t.style.textShadow="0 0 20px rgba(0, 0, 0, 0.8)",t.style.letterSpacing="3px",t.style.textTransform="uppercase",t.style.opacity="0",t.style.cursor="pointer",t.style.pointerEvents="auto";const e=i.height+2,n=i.centroid.x,r=-i.centroid.z,s=new $m(t);s.position.set(n,e,r),$r.add(s),Vi.push({label:s,target:i,el:t,baseY:e})}const cl="Nikola Milojevic-Dupont – Scientific Consulting",ul="Geospatial Data + AI  ->  Climate + Cities",Ql="position: fixed; left: 50%; transform: translateX(-50%); z-index: 20; text-align: center; font-family: monospace; color: #fff; opacity: 0; pointer-events: none;",tc="font-size: 20px; font-weight: 700; letter-spacing: 2px; white-space: nowrap; overflow: hidden; min-height: 1.4em;",Or=document.createElement("div");Or.style.cssText=Ql+" top: 3%; "+tc;document.body.appendChild(Or);const Br=document.createElement("div");Br.style.cssText=Ql+" bottom: 3%; "+tc;document.body.appendChild(Br);let ec=!1,nc=!1,Ls=0;const ig=1,rg=2.5;function sg(){ec=!0,Or.style.opacity="1",Br.style.opacity="1";let i=0;const t=setInterval(()=>{if(Or.textContent+=cl[i],i++,i>=cl.length){clearInterval(t);let e=0;const n=setInterval(()=>{Br.textContent+=ul[e],e++,e>=ul.length&&(clearInterval(n),nc=!0)},30)}},35)}const ag=1.2;let zr=!1,za=0,ke=0;function og(i){return i<.5?2*i*i:-1+(4-2*i)*i}const Vn=document.createElement("div");Vn.id="about-panel";Vn.style.cssText=["position: fixed","right: 0","top: 10%","width: 44%","height: 80%","z-index: 25","font-family: monospace","color: #fff","pointer-events: none","opacity: 0","transform: translateX(100%)","transition: none"].join(";")+";";document.body.appendChild(Vn);const Yi=document.createElement("div");Yi.style.cssText=["padding: 4% 8% 0 8%","height: 100%","overflow-y: auto","pointer-events: auto","box-sizing: border-box"].join(";")+";";Vn.appendChild(Yi);const Hr=document.createElement("h1");Hr.style.cssText=["font-size: 20px","font-weight: 700","letter-spacing: 3px","text-transform: uppercase","margin: 0 0 28px 0","min-height: 1.4em","overflow: hidden","white-space: nowrap"].join(";")+";";Yi.appendChild(Hr);const fi=document.createElement("div");fi.style.cssText=["font-size: 14px","line-height: 1.7","letter-spacing: 0.5px","opacity: 0"].join(";")+";";const hl=["I am a freelancer based in Berlin, Germany.","I am available for missions in the space of AI, geospatial data, climate change, urban planning – or an intersection of these topics.","My expertise includes:","• Data science project implementation","• Consulting, management, or auditing of AI for Climate projects","• Development and delivery of education programs","My work has broadly investigated the pathway from research to deployment of AI systems for climate action in cities, focusing on narratives, data needs, tool development, and practical deployment considerations. I have particular expertise in geospatial data science, gained, for example, from leading the development of the EUBUCCO building stock dataset (eubucco.com).","I hold a PhD from the Technical University Berlin and wrote my doctoral dissertation on “Geospatial artificial intelligence for scaling low-carbon planning” under the supervision of Felix Creutzig. I worked for 7 years in Felix Creutzig’s lab at MCC Berlin, now part of the renowned Potsdam Institute for Climate Impact Research (PIK).","I am also a founding member of Climate Change AI (CCAI), a global non-profit aiming to catalyze impactful work at the intersection of climate change and machine learning, where I have taken on various roles, including chairing the organization’s educational content committee and being a member of its board of directors."];for(let i=0;i<hl.length;i++){const t=document.createElement("p");t.textContent=hl[i],t.style.margin="0 0 0.6em 0",i===6&&(t.style.marginTop="1.2em"),fi.appendChild(t)}Yi.appendChild(fi);const He=document.createElement("span");He.textContent="[ close ]";He.style.cssText=["display: inline-block","margin-top: 6px","font-size: 14px","font-weight: 700","letter-spacing: 2px","cursor: pointer","pointer-events: auto","opacity: 0","transition: opacity 0.3s"].join(";")+";";He.addEventListener("mouseenter",()=>{He.style.textShadow="0 0 12px rgba(255,255,255,0.5)"});He.addEventListener("mouseleave",()=>{He.style.textShadow="none"});Yi.appendChild(He);He.addEventListener("click",ug);function lg(){Hr.textContent="",fi.style.opacity="0",He.style.opacity="0";let i=0;const t="About",e=setInterval(()=>{Hr.textContent+=t[i],i++,i>=t.length&&(clearInterval(e),fi.style.transition="opacity 0.6s",fi.style.opacity="1",He.style.transition="opacity 0.6s",He.style.opacity="1")},35)}function cg(){if(!(zr||ke!==0)){zr=!0,ke=1,za=Ha.getElapsedTime();for(const i of Vi)i.el.style.opacity="0";Vn.style.opacity="1",lg()}}function ug(){if(!(!zr||ke!==0)){zr=!1,ke=-1,za=Ha.getElapsedTime();for(const i of Vi)i.el.style.opacity="0.95"}}const fl=new Zm,Ds=new ut,Vr=new Set,hg=hi.map(i=>i.mesh);let Fi=!1;En.domElement.addEventListener("pointermove",i=>{if(!Fi)return;Ds.x=i.clientX/window.innerWidth*2-1,Ds.y=-(i.clientY/window.innerHeight)*2+1,fl.setFromCamera(Ds,an);const t=fl.intersectObjects(hg);Vr.clear();for(const e of t){const n=hi.find(r=>r.mesh===e.object);n&&Vr.add(n)}});En.domElement.addEventListener("click",()=>{if(Fi)for(const i of Vr)i.label==="About"?cg():console.log("Clicked:",i.label,i.mesh.position)});const Ha=new Ym;function dl(i,t){return Math.min(1,Math.max(0,(i-Te.start[t])/Te.dur[t]))}function ic(){requestAnimationFrame(ic);const i=Ha.getElapsedTime();if(i>=Te.start[pe.EDGES]&&i<Ar(pe.EDGES)){const e=dl(i,pe.EDGES);Ln.length>0&&(Ln[0].line.material.opacity=e)}else i>=Ar(pe.EDGES)&&Ln.length>0&&(Ln[0].line.material.opacity=1);if(i>=Te.start[pe.SAMPLE_20]&&i<Ar(pe.SAMPLE_20))for(const e of Ln)e.colorPhase===2&&e.material.color.copy(e.baseColor);if(i>=Te.start[pe.ALL_COLOR]){const e=i<Ar(pe.ALL_COLOR)?dl(i,pe.ALL_COLOR):1;for(const n of Ln)n.colorPhase===3&&n.material.color.copy(n.baseColor).multiplyScalar(e)}if(i>=Te.start[pe.EXTRUDE]){for(const e of Ln){const n=Te.start[pe.EXTRUDE]+e.extrudeDelay,r=i<=n?0:Math.min(1,(i-n)/Te.dur[pe.EXTRUDE]);e.mesh.scale.z=r,e.line.scale.z=r}for(const e of hi){const n=Te.start[pe.EXTRUDE]+e.extrudeDelay,r=i<=n?0:Math.min(1,(i-n)/Te.dur[pe.EXTRUDE]);for(const s of e.glows)s.mesh.scale.z=r}}if(i>=Te.start[pe.GLOW]&&!ec&&sg(),nc){Ls===0&&(Ls=i);const e=ig,n=Math.max(0,i-Ls-e),r=Math.min(1,n/rg);for(const s of hi){s.mesh.visible=!0,s.line.visible=!0,s.material.color.copy(s.baseColor).multiplyScalar(r),s.mesh.scale.z=r,s.line.scale.z=r;for(const a of s.glows)a.mesh.visible=!0,a.material.opacity=a.baseOpacity*r}for(const s of Vi)s.el.style.opacity=String(.95*r);r>=1&&!Fi&&(Fi=!0)}if(ke!==0){const e=Math.min(1,(i-za)/ag),n=og(e),r=ke===1?0:-200,s=ke===1?-200:0;$r.position.x=r+(s-r)*n;const a=ke===1?100:0,l=a+((ke===1?0:100)-a)*n;Vn.style.transform="translateX("+l+"%)",Vn.style.opacity=String(e),e>=1&&(ke=0)}if(!Fi){En.render(oi,an),qe.render(oi,an);return}const t=Math.sin(i*2)*.5+.5;for(const e of hi){const n=Vr.has(e),r=n?1.8:1,s=.85+t*.15*r;for(const a of e.glows){a.material.opacity=a.baseOpacity*s;const o=1+t*.002*r;a.mesh.scale.set(o,o,o)}if(n){const a=e.baseColor.clone();a.lerp(new Gt(16777215),.4),e.material.color.copy(a)}else e.material.color.copy(e.baseColor)}for(const e of Vi){const n=Math.sin(i*1.5+e.target.centroid.x)*4;e.label.position.y=e.baseY+n}En.render(oi,an),qe.render(oi,an)}ic();
